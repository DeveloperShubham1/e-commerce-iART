    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
                <div>
                    <h2 className="text-xl font-bold text-slate-800"> {orders?.[0]?.merchant?.MerchantName || "Merchant"} Orders</h2>
                    <p className="text-sm text-slate-500">View all order of merchants</p>
                </div>
